...
export class FileUpload {
	...
	async upload() {
		...
		this.reader.onerror = (evt) => {
			this.modal_prompt.alert(_("Failed to read file: ") + this.filename, _("Upload of directories not supported."));
			this.done();
		}
		...
		try {
			...
			if (this.using_webkit) {
				...
				this.modal_prompt.alert(_("Failed to read file: ") + this.filename, _("Upload of directories and empty files not supported."));
			}
			this.done();
		}
